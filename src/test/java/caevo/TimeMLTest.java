...
public class TimeMLTest {
	...
	public TimeMLTest(Main main, String id, String directory, String inName, String inputText, String expectedOutput, String gold, String alignment) {
		this.main = main;
		this.id = id;
	...
	public static Collection<?> initParams() throws Exception {
		...
		// Constants
		String directoryName = "timeml";
		String testProperties = "test.properties";

		// Read test properties file
		ClassLoader classLoader = TimeMLTest.class.getClassLoader();
