...
public class TextEvent {
    ...
    private void addEiidsFromAttributeString(String str) {
        ...
        for (String part : parts) addEiid(part);
    }
...
//    System.out.println("  finished with " + eiids);
    ...
    private String buildEiidString() {
        String str = "";
        if (this.eiids == null || this.eiids.isEmpty()) return str;
        str = eiids.get(0);
     ...
     *
     * @param eiid An eiid such as "ei5"
    ...
    public boolean isBeforeInText(TextEvent other) {
        return sid < other.getSid() || sid == other.getSid() && index < other.getIndex();
    }
     ...
     *
     * @param otherObj The other object to compare against.
     * @return True if they are the same, false otherwise.
     */
    public boolean equals(Object otherObj) {
        if (otherObj instanceof TextEvent) {
            TextEvent other = (TextEvent) otherObj;
            return this.ID.equals(other.getId()) && this.sid == other.getSid() && getString().equals(other.getString());
        }
        return false;
    }

    public String toString() {
        return this.ID + "(" + this.buildEiidString() + ") " + getString() + "-" + this.index;
    }
}
